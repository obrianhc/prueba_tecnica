...
const _0x3c4d = [
    ...
    '            <p style="color:#faa;font-size:1.2rem;">${atob("UHJ1ZWJhIGRlIGNpYmVyc2VndXJpZGFkIGZhbGxpZGEu")}</p>',
    '            <p style="color:#f00;font-weight:bold;margin-top:1rem;font-family:monospace;">${atob("PiBJTklDSUFORE8gUFJPVE9DT0xPIERFIEJPUlJBRE8uLi4=")}</p>',
    '        </div>',
